...
if(USE_HTTPS)
	...
	if(USE_HTTPS STREQUAL ON)
		...
		elseif(MBEDTLS_FOUND OR EXISTS "${PROJECT_SOURCE_DIR}/deps/mbedtls/library")
	...
	elseif(USE_HTTPS STREQUAL "mbedtls")
		if(NOT MBEDTLS_FOUND)
			# Fallback to bundled mbedTLS (deps/mbedtls/)
			if(EXISTS "${PROJECT_SOURCE_DIR}/deps/mbedtls/library")
				message(STATUS "System mbedTLS not found, using bundled")
				add_subdirectory("${PROJECT_SOURCE_DIR}/deps/mbedtls"
					"${PROJECT_BINARY_DIR}/deps/mbedtls")
				set(MBEDTLS_INCLUDE_DIR "${PROJECT_SOURCE_DIR}/deps/mbedtls/include")
				list(APPEND LIBGIT2_DEPENDENCY_OBJECTS $<TARGET_OBJECTS:mbedtls_bundled>)
			else()
